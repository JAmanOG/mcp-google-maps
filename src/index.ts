...
export interface UsertransistData {
  origin: string;
  destination: string;
...
const GOOGLE_QUERY_MAPS_API_URL =
...
server.tool(
  "user-query-fulfillment",
  "Fulfill the user query searching about some location on Google Maps",
  {
...
server.tool("transit-data-fetch",
  "Fetch transit data for a user-defined origin and destination.",
    {
        userData: z.object({
